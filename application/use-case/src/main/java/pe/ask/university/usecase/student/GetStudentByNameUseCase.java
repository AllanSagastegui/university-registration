...
/**
 * Use case for retrieving a {@link Student} by their name.
 * <p>
 * This class implements the {@link IGetStudentByNameUseCase} interface and provides the
 ...
 */
@UseCase
public class GetStudentByNameUseCase implements IGetStudentByNameUseCase {

    private final IStudentRepository repository;

    /**
     * Constructs a new {@code GetStudentByNameUseCase}.
     *
     * @param repository The repository for student persistence operations.
     */
    public GetStudentByNameUseCase(IStudentRepository repository) {
     ...
     * provided name. If no student is found with the given name, it emits a
